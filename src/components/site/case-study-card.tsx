...
export function CaseStudyCard({
  ...
  return (
    <a
      href={`#${study.slug}`}
      className={cn(
        "group relative flex flex-col overflow-hidden rounded-3xl border border-border/70 bg-card transition-all duration-300 hover:-translate-y-1 hover:border-border hover:shadow-[0_30px_80px_-30px_rgba(0,0,0,0.6)]",
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 flex items-end p-5">
          <div className="w-full space-y-2 rounded-xl border border-white/25 bg-white/10 p-3 backdrop-blur-md transition-transform duration-500 group-hover:-translate-y-1">
        ...
        <div className="absolute top-4 right-4 flex size-9 items-center justify-center rounded-full bg-white/15 text-white opacity-0 backdrop-blur-md transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100 -translate-x-1">
      ...
      <div className="flex flex-1 flex-col gap-3 p-5 sm:p-6">
        ...
        <h3 className="font-display text-xl leading-snug font-medium text-balance sm:text-2xl">
          {study.title}
        </h3>
