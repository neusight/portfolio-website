      ...
      <Reveal>
        ...
        <div className="mt-6 max-w-2xl space-y-4 text-muted-foreground">
          <p>
            ...
            cross-functional teams, and leveraging AI to solve real business
            problems. Most recently I&rsquo;ve led enterprise pricing
            experiences at Kroger, partnering with Product, Engineering,
            Pricing Strategy, Data Science, and executives to define product
            vision and roadmap.
          </p>
          <p>
            &ldquo;I bridge the gap between business strategy and user needs
            to create experiences that drive results, adoption, and
          ...
          <p>
            ...
            manage around — it&rsquo;s a discipline I own, which is why the
            initiatives I lead ship on schedule.
          </p>
        </div>
